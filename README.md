...
- モニターや操作デバイスを端末に付けずに運用する場合は、同じネットワーク内でスマートフォンなどからブラウザにローカルIPアドレスを入力してアクセスすることで操作することが可能です。
...
※ 物理的停止ボタンが基本存在しない事と、モニター無しでスケジュール機能を使用するケースも考えられる、現状は最後まで再生されたらそこで終了します。
